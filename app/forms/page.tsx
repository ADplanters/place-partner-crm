...
export default function FormsPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F8F9FA] p-8 text-gray-900">
        ...
        <div className="flex items-center justify-between mb-8">
          <div className="flex items-center gap-4">
            <button
              ...
              className="p-2.5 rounded-xl bg-white border border-gray-200 text-gray-600 hover:bg-gray-50 transition-all"
            >
              <ArrowLeft size={18} />
            </button>
            <div>
        ...
        <div className="flex flex-col md:flex-row gap-4 justify-between items-center mb-6">
          ...
          <div className="relative w-full md:w-72">
            ...
            <input
              ...
              className="w-full pl-10 pr-4 py-2.5 rounded-xl border border-gray-200 text-xs font-bold bg-white outline-none focus:border-blue-600"
            />
          </div>
        </div>
